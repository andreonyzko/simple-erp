...
export class ERPDataBase extends Dexie {
  ...
  constructor() {
    ...
    this.version(1).stores({
      ...
      products:
        "++id, name, supplierId, stockControl, stock, cost, sellPrice, active",
      services: "++id, name, price, active",
      purchases: "++id, supplierId, date, totalValue, status",
      sales: "++id, clientId, date, totalValue, status",
      transactions: "++id, title, type, origin, date, referenceId, value",
    });
  }
}
